...
function modelsByManufacturer($manufacturer) {
  if (!$con = connectDB()) $res = "ERR";    // si échec de connexion
    ...
    $req = "SELECT ID, Suffix, Manufacturer, ModelNo, ManuPartCode, LampHours, Trade_Price, Available_Stock, Display, Wattage, LampType FROM fr_trade WHERE manufacturer='$manufacturer' AND (ID < 6000000 or ID >= 7000000) ORDER BY ModelNo ASC";
