...
<html><head>
<title><? echo $videoprojecteur ?> <? echo $modele ?></title>
...
<?
if (file_exists('/home/wwwuser/sites/lampe-videoprojecteur.info/www/photos/'.$videoprojecteur.'-'.$modele.'.jpg')) {
  echo '<img src="photos/'.$videoprojecteur.'-'.$modele.'.jpg" border="5" alt="'.$videoprojecteur.' '.$modele.'">';
}
?>
...
<?
if (file_exists('/home/wwwuser/sites/lampe-videoprojecteur.info/www/presentation/'.$videoprojecteur.'-'.$modele.'.txt')) {
...
<td align="center">
Le <? echo $modele ?> de chez <? echo $videoprojecteur ?>
</td></tr>
...
<?
if (file_exists('/home/wwwuser/sites/lampe-videoprojecteur.info/www/manuels/'.$videoprojecteur.'-'.$modele.'.pdf')) {
...
<?
if (file_exists('/home/wwwuser/sites/lampe-videoprojecteur.info/www/brochures/'.$videoprojecteur.'-'.$modele.'.pdf')) {
...
<?
if (file_exists('/home/wwwuser/sites/lampe-videoprojecteur.info/www/technique/'.$videoprojecteur.'-'.$modele.'.pdf')) {
